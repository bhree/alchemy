...
minetest.register_on_player_receive_fields(
	function(player, formname, fields)
		...
		--minetest.chat_send_all("D " .. formname .. " " .. minetest.serialize(fields))
...
minetest.register_craftitem("alchemy:essence_low", {
	...
	inventory_image = "alchemy_essence_base.png^[colorize:#0000FF:180",
	stack_max = 30000,
})

minetest.register_craftitem("alchemy:essence_medium", {
	description = "Medium essence",
	inventory_image = "alchemy_essence_base.png^[colorize:#00FF00:180",
	stack_max = 30000,	
})

minetest.register_craftitem("alchemy:essence_high", {
	description = "High essence",
	inventory_image = "alchemy_essence_base.png^[colorize:#FF0000:180",
	stack_max = 30000,
})

minetest.register_craftitem("alchemy:essence_upgrade", {
	description = "Upgrade essence",
	inventory_image = "alchemy_essence_base.png^[colorize:#FFFF00:180",
	stack_max = 30000,
})
